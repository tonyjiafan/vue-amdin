  ...
  <Dropdown ref="dropdown"
    ...
    <a class="drop-menu-a"
      ...
      <common-icon :size="rootIconSize"
                   :color="textColor"
                   :type="parentItem.meta.icon" /><span class="menu-title"
      ...
      <template v-for="child in children">
        ...
        <DropdownItem v-else
          ...
          <common-icon :size="iconSize"
                       :type="child.meta.icon" /><span class="menu-title">{{ showTitle(child) }}</span></DropdownItem>
      </template>
    </DropdownMenu>
  </Dropdown>
</template>
...
import { findNodeUpperByClasses } from '@/utils/side-utils'
